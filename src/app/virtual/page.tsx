  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-2">AulaPass Virtual</h1>
        <p className="text-center text-gray-600 mb-8">Registro de Asistencia por Contingencia</p>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">CUI / DNI (8 dígitos)</label>
            <input
              type="text"
              value={cui}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Código de Sesión (6 dígitos)</label>
            <input
              type="text"
              value={virtualCode}
